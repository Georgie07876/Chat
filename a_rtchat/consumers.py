...
class ChatroomConsumer(WebsocketConsumer):
    ...
    def message_handler(self, event):
        ...
        html = render_to_string("C:/Users\CityLine\Desktop\ЧатПитон\online-main/a_rtchat/templates\partials\chat_message_p.html", context=context)
    ...
    def online_count_handler(self, event):
        ...
        html = render_to_string("C:/Users\CityLine\Desktop\ЧатПитон\online-main/a_rtchat/templates\online_count.html", context)
        self.send(text_data=html)
...
class OnlineStatusConsumer(WebsocketConsumer):
    ...
    def online_status_handler(self, event):
        ...
        html = render_to_string("C:/Users\CityLine\Desktop\ЧатПитон\online-main/a_rtchat/templates\partials\online_status.html", context=context)
        self.send(text_data=html)